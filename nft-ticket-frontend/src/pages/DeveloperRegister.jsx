...
function DeveloperRegister() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await developerAPI.register({ name, email, password });

            if (response.data.success) {
                navigate('/developer/login', { state: { message: 'Registration successful! Please login.' } });
            } else {
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4 py-8 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/3 -left-20 w-72 h-72 bg-blue-600/20 rounded-full blur-3xl"></div>
                <div className="absolute bottom-1/3 -right-20 w-72 h-72 bg-cyan-600/20 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold">
                        <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Developer Sign Up</span>
                    </h1>
                    <p className="text-gray-400 mt-2">Create an account to get your API key</p>
                </div>
                ...
                <div className="glass rounded-xl p-8 animate-fade-in-up">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label className="block text-gray-300 text-sm font-medium mb-2">Name / Company</label>
                            <input
                                type="text"
                                value={name}
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-gray-400">
                            ...
                            <Link to="/developer/login" className="text-blue-400 hover:text-blue-300 font-medium">
                                Login
                            </Link>
                        </p>
                    </div>
